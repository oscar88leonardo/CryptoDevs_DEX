...
contract Exchange is ERC20 {
    ...
    //  Exchangue is inheriting ERC20, because our exchange would keep track of Crypto Dev LP tokens
    ...
    function addLiquidity(uint _amount) public payable returns (uint) {
        ...
        /*
        if the reserve is empty, intake any user supplied value for 'Ether' and 
        'Crypto Dev' tokens because there is no ratio currently
        */
       if (cryptoDevTokenReserve == 0){
        ...
        // is adding 'ETH' to the contract, so wahtever 'ETH' contract has is equal to the one supplied
        ...
        */
        ...
        // transfer only (cryptoDevTokenAmount user can add) amount of 'Crypto Dev tokens' from user account
        // to the contract
    ...
    */
    function getAmountOfTokens(
        ...
        // we need to make sure (x+dx) * (y-dy) = x*y
        // So the final formula is dy = (y*dx)/(x+dx)
        // dy in our case is 'tokens to be received'
        ...
        /*
        * @dev Swap Eth for CryptoDev Tokens
        */
       function ethToCryptoDevToken(uint _minTokens) public payable {
        ...
        // 'address(this).balance - msg.value' intead of just 'address(this).balance0
        // because 'address(this).balance' already contains the 'msg.value' user has sent in the given call
        // so we need to subtract ir to get the actual input reserve
        ...
        // Transfer the 'CryptoDev' tokens to the user
